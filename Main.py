...
#essa imprimir estado geral o gemini que fez, vou refazer depois
def imprimir_estado_geral(memoria, processadores):
    ...
    # 1. Mostrar um resumo da RAM (apenas as primeiras 15 posições para não poluir)
